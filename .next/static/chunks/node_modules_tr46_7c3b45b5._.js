...
function mapChars(domainName, param) {
    let { transitionalProcessing } = param;
    let processed = "";
...
function validateLabel(label, param) {
    let { checkHyphens, checkBidi, checkJoiners, transitionalProcessing, useSTD3ASCIIRules, isBidi } = param;
...
function toASCII(domainName) {
    let { checkHyphens = false, checkBidi = false, checkJoiners = false, useSTD3ASCIIRules = false, verifyDNSLength = false, transitionalProcessing = false, ignoreInvalidPunycode = false } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
function toUnicode(domainName) {
    let { checkHyphens = false, checkBidi = false, checkJoiners = false, useSTD3ASCIIRules = false, transitionalProcessing = false, ignoreInvalidPunycode = false } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const result = processing(domainName, {
        checkHyphens,
        checkBidi,
        checkJoiners,
