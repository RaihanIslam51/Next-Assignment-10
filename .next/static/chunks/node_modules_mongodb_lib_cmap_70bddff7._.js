...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/constants.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/on_demand/document.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @internal */ class OnDemandDocument {
    ...
    getNumber(name, required) {
        ...
        var _ref, _ref1;
        const result = (_ref1 = (_ref = bool !== null && bool !== void 0 ? bool : long) !== null && _ref !== void 0 ? _ref : this.get(name, bson_1.BSONType.int)) !== null && _ref1 !== void 0 ? _ref1 : this.get(name, bson_1.BSONType.double);
...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/responses.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @internal */ class MongoDBResponse extends document_1.OnDemandDocument {
     ...
     */ get isMaxTimeExpiredError() {
        ...
        const isWriteConcern = ((_this_get = this.get('writeConcernError', bson_1.BSONType.object)) === null || _this_get === void 0 ? void 0 : _this_get.getNumber('code')) === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired;
        ...
        if (writeErrors === null || writeErrors === void 0 ? void 0 : writeErrors.size()) {
            for(let i = 0; i < writeErrors.size(); i++){
                var _writeErrors_get;
                const isWriteError = ((_writeErrors_get = writeErrors.get(i, bson_1.BSONType.object)) === null || _writeErrors_get === void 0 ? void 0 : _writeErrors_get.getNumber('code')) === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired;
     ...
     */ get recoveryToken() {
        var _this_get;
        var _this_get_toObject;
        return (_this_get_toObject = (_this_get = this.get('recoveryToken', bson_1.BSONType.object)) === null || _this_get === void 0 ? void 0 : _this_get.toObject({
            promoteValues: false,
            promoteLongs: false,
        ...
        })) !== null && _this_get_toObject !== void 0 ? _this_get_toObject : null;
    }
    /**
     ...
     */ get atClusterTime() {
        var _this_get;
        var _this_get_get;
        return (_this_get_get = (_this_get = this.get('cursor', bson_1.BSONType.object)) === null || _this_get === void 0 ? void 0 : _this_get.get('atClusterTime', bson_1.BSONType.timestamp)) !== null && _this_get_get !== void 0 ? _this_get_get : this.get('atClusterTime', bson_1.BSONType.timestamp);
    }
    get operationTime() {
    ...
    get $clusterTime() {
        if (!('clusterTime' in this)) {
            ...
            const signature = (_clusterTimeDoc_get = clusterTimeDoc.get('signature', bson_1.BSONType.object)) === null || _clusterTimeDoc_get === void 0 ? void 0 : _clusterTimeDoc_get.toObject();
        ...
        var _this_clusterTime;
        return (_this_clusterTime = this.clusterTime) !== null && _this_clusterTime !== void 0 ? _this_clusterTime : null;
    }
    toObject(options) {
        const exactBSONOptions = {
            ...(0, bson_1.pluckBSONSerializeOptions)(options !== null && options !== void 0 ? options : {}),
...
/** @internal */ class CursorResponse extends MongoDBResponse {
    ...
    get encryptedBatch() {
        var _this_encryptedResponse;
        if (this.encryptedResponse == null) return null;
        if (this._encryptedBatch != null) return this._encryptedBatch;
        const cursor = (_this_encryptedResponse = this.encryptedResponse) === null || _this_encryptedResponse === void 0 ? void 0 : _this_encryptedResponse.get('cursor', bson_1.BSONType.object);
        if (cursor === null || cursor === void 0 ? void 0 : cursor.has('firstBatch')) this._encryptedBatch = cursor.get('firstBatch', bson_1.BSONType.array, true);
        else if (cursor === null || cursor === void 0 ? void 0 : cursor.has('nextBatch')) this._encryptedBatch = cursor.get('nextBatch', bson_1.BSONType.array, true);
    ...
    get batchSize() {
        var _this_batch;
        return (_this_batch = this.batch) === null || _this_batch === void 0 ? void 0 : _this_batch.size();
    }
    get postBatchResumeToken() {
        var _this_cursor_get;
        var _this_cursor_get_toObject;
        return (_this_cursor_get_toObject = (_this_cursor_get = this.cursor.get('postBatchResumeToken', bson_1.BSONType.object)) === null || _this_cursor_get === void 0 ? void 0 : _this_cursor_get.toObject({
            promoteValues: false,
            promoteLongs: false,
            promoteBuffers: false,
            validation: {
        ...
        })) !== null && _this_cursor_get_toObject !== void 0 ? _this_cursor_get_toObject : null;
    }
    shift(options) {
        var _this_encryptedBatch;
        if (this.iterated >= this.batchSize) {
            return null;
        }
        var _this_batch_get;
        const result = (_this_batch_get = this.batch.get(this.iterated, bson_1.BSONType.object, true)) !== null && _this_batch_get !== void 0 ? _this_batch_get : null;
        var _this_encryptedBatch_get;
        const encryptedResult = (_this_encryptedBatch_get = (_this_encryptedBatch = this.encryptedBatch) === null || _this_encryptedBatch === void 0 ? void 0 : _this_encryptedBatch.get(this.iterated, bson_1.BSONType.object, true)) !== null && _this_encryptedBatch_get !== void 0 ? _this_encryptedBatch_get : null;
        this.iterated += 1;
...
"[project]/node_modules/mongodb/lib/cmap/auth/auth_provider.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/gssapi.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
async function makeKerberosClient(authContext) {
    ...
    var _mechanismProperties_SERVICE_NAME;
    const serviceName = (_mechanismProperties_SERVICE_NAME = mechanismProperties.SERVICE_NAME) !== null && _mechanismProperties_SERVICE_NAME !== void 0 ? _mechanismProperties_SERVICE_NAME : 'mongodb';
    ...
    var _mechanismProperties_SERVICE_HOST;
    const spnHost = (_mechanismProperties_SERVICE_HOST = mechanismProperties.SERVICE_HOST) !== null && _mechanismProperties_SERVICE_HOST !== void 0 ? _mechanismProperties_SERVICE_HOST : host;
    let spn = "".concat(serviceName).concat(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '@').concat(spnHost);
...
"[project]/node_modules/mongodb/lib/cmap/auth/providers.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongo_credentials.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class MongoCredentials {
    ...
    validate() {
        ...
        var _this_mechanismProperties_CANONICALIZE_HOST_NAME;
        const canonicalization = (_this_mechanismProperties_CANONICALIZE_HOST_NAME = this.mechanismProperties.CANONICALIZE_HOST_NAME) !== null && _this_mechanismProperties_CANONICALIZE_HOST_NAME !== void 0 ? _this_mechanismProperties_CANONICALIZE_HOST_NAME : false;
        if (!Object.values(gssapi_1.GSSAPICanonicalizationValue).includes(canonicalization)) {
            throw new error_1.MongoAPIError("Invalid CANONICALIZE_HOST_NAME value: ".concat(canonicalization));
        }
    }
    static merge(creds, options) {
        var _options_username, _ref, _options_password, _ref1, _options_mechanism, _ref2, _options_mechanismProperties, _ref3, _options_source, _ref4, _ref5;
        return new MongoCredentials({
            username: (_ref = (_options_username = options.username) !== null && _options_username !== void 0 ? _options_username : creds === null || creds === void 0 ? void 0 : creds.username) !== null && _ref !== void 0 ? _ref : '',
            password: (_ref1 = (_options_password = options.password) !== null && _options_password !== void 0 ? _options_password : creds === null || creds === void 0 ? void 0 : creds.password) !== null && _ref1 !== void 0 ? _ref1 : '',
            mechanism: (_ref2 = (_options_mechanism = options.mechanism) !== null && _options_mechanism !== void 0 ? _options_mechanism : creds === null || creds === void 0 ? void 0 : creds.mechanism) !== null && _ref2 !== void 0 ? _ref2 : providers_1.AuthMechanism.MONGODB_DEFAULT,
            mechanismProperties: (_ref3 = (_options_mechanismProperties = options.mechanismProperties) !== null && _options_mechanismProperties !== void 0 ? _options_mechanismProperties : creds === null || creds === void 0 ? void 0 : creds.mechanismProperties) !== null && _ref3 !== void 0 ? _ref3 : {},
            source: (_ref5 = (_ref4 = (_options_source = options.source) !== null && _options_source !== void 0 ? _options_source : options.db) !== null && _ref4 !== void 0 ? _ref4 : creds === null || creds === void 0 ? void 0 : creds.source) !== null && _ref5 !== void 0 ? _ref5 : 'admin'
        });
    }
    constructor(options){
        var _options_username;
        this.username = (_options_username = options.username) !== null && _options_username !== void 0 ? _options_username : '';
...
"[project]/node_modules/mongodb/lib/cmap/handshake/client_metadata.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ function makeClientMetadata(options) {
    ...
    for (const { name: n = '', version: v = '' } of options.additionalDriverInfo){
        if (n.length > 0) {
            driverInfo.name = "".concat(driverInfo.name, "|").concat(n);
        }
        if (v.length > 0) {
            driverInfo.version = "".concat(driverInfo.version, "|").concat(v);
        }
    }
    ...
    for (const { platform: p = '' } of options.additionalDriverInfo){
        if (p.length > 0) {
            runtimeInfo = "".concat(runtimeInfo, "|").concat(p);
        }
    }
...
/** @internal */ async function getContainerMetadata() {
    ...
    dockerPromise !== null && dockerPromise !== void 0 ? dockerPromise : dockerPromise = (0, utils_1.fileIsAccessible)('/.dockerenv');
 ...
 */ async function addContainerMetadata(originalMetadata) {
    ...
    const extendedEnvMetadata = {
        ...originalMetadata === null || originalMetadata === void 0 ? void 0 : originalMetadata.env,
 ...
 */ function getRuntimeInfo() {
    if ('Deno' in globalThis) {
        var _Deno_version, _Deno, _Deno_version1, _Deno1;
        const version = typeof ((_Deno = Deno) === null || _Deno === void 0 ? void 0 : (_Deno_version = _Deno.version) === null || _Deno_version === void 0 ? void 0 : _Deno_version.deno) === 'string' ? (_Deno1 = Deno) === null || _Deno1 === void 0 ? void 0 : (_Deno_version1 = _Deno1.version) === null || _Deno_version1 === void 0 ? void 0 : _Deno_version1.deno : '0.0.0-unknown';
        return "Deno v".concat(version, ", ").concat(os.endianness());
    }
    if ('Bun' in globalThis) {
        var _Bun, _Bun1;
        const version = typeof ((_Bun = Bun) === null || _Bun === void 0 ? void 0 : _Bun.version) === 'string' ? (_Bun1 = Bun) === null || _Bun1 === void 0 ? void 0 : _Bun1.version : '0.0.0-unknown';
        return "Bun v".concat(version, ", ").concat(os.endianness());
    }
    return "Node.js ".concat(process.version, ", ").concat(os.endianness());
} //# sourceMappingURL=client_metadata.js.map
}),
"[project]/node_modules/mongodb/lib/cmap/commands.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @internal */ class OpQueryRequest {
    ...
    constructor(databaseName, query, options){
        ...
        const ns = "".concat(databaseName, ".$cmd");
        ...
        this.requestId = (_options_requestId = options.requestId) !== null && _options_requestId !== void 0 ? _options_requestId : OpQueryRequest.getRequestId();
...
/** @internal */ class OpReply {
    ...
    parse() {
        ...
        if (this.numberReturned < 0 || this.numberReturned > 2 ** 32 - 1) {
            throw new RangeError("OP_REPLY numberReturned is an invalid array length ".concat(this.numberReturned));
        }
...
/** @internal */ class DocumentSequence {
     ...
     */ push(document, buffer) {
        ...
        (_this_header = this.header) === null || _this_header === void 0 ? void 0 : _this_header.writeInt32LE(4 + this.field.length + 1 + this.serializedDocumentsLength, 1);
     ...
     */ constructor(field, documents){
        ...
        encodeUTF8Into(buffer, "".concat(this.field, "\0"), 5);
        this.chunks.push(buffer);
        this.header = buffer;
        if (documents) {
...
/** @internal */ class OpMsgRequest {
    ...
    constructor(databaseName, command, options){
        ...
        var _options_moreToCome;
        this.moreToCome = (_options_moreToCome = options.moreToCome) !== null && _options_moreToCome !== void 0 ? _options_moreToCome : ((_command_writeConcern = command.writeConcern) === null || _command_writeConcern === void 0 ? void 0 : _command_writeConcern.w) === 0;
...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/compression.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ async function compressCommand(command, description) {
    var _description_agreedCompressor, _description_zlibCompressionLevel;
    const finalCommand = description.agreedCompressor === 'none' || !commands_1.OpCompressedRequest.canCompress(command) ? command : new commands_1.OpCompressedRequest(command, {
        agreedCompressor: (_description_agreedCompressor = description.agreedCompressor) !== null && _description_agreedCompressor !== void 0 ? _description_agreedCompressor : 'none',
        zlibCompressionLevel: (_description_zlibCompressionLevel = description.zlibCompressionLevel) !== null && _description_zlibCompressionLevel !== void 0 ? _description_zlibCompressionLevel : 0
    });
...
"[project]/node_modules/mongodb/lib/cmap/auth/aws_temporary_credentials.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class AWSTemporaryCredentialProvider {
    static get awsSDK() {
        var _AWSTemporaryCredentialProvider;
        var __awsSDK;
        (__awsSDK = (_AWSTemporaryCredentialProvider = AWSTemporaryCredentialProvider)._awsSDK) !== null && __awsSDK !== void 0 ? __awsSDK : _AWSTemporaryCredentialProvider._awsSDK = (0, deps_1.getAwsCredentialProvider)();
 ...
 */ class LegacyAWSTemporaryCredentialProvider extends AWSTemporaryCredentialProvider {
    async getCredentials() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI) {
            return await (0, utils_1.request)("".concat(AWS_RELATIVE_URI).concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI));
        }
        // Otherwise assume we are on an EC2 instance
        // get a token
        const token = await (0, utils_1.request)("".concat(AWS_EC2_URI, "/latest/api/token"), {
            method: 'PUT',
            json: false,
            headers: {
        ...
        // get role name
        const roleName = await (0, utils_1.request)("".concat(AWS_EC2_URI, "/").concat(AWS_EC2_PATH), {
            json: false,
            headers: {
        ...
        const creds = await (0, utils_1.request)("".concat(AWS_EC2_URI, "/").concat(AWS_EC2_PATH, "/").concat(roleName), {
            headers: {
                'X-aws-ec2-metadata-token': token
            }
        });
...
"[project]/node_modules/mongodb/lib/cmap/metrics.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/shared.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function getReadPreference(options) {
    ...
    let readPreference = (_options_readPreference = options === null || options === void 0 ? void 0 : options.readPreference) !== null && _options_readPreference !== void 0 ? _options_readPreference : read_preference_1.ReadPreference.primary;
...
"[project]/node_modules/mongodb/lib/cmap/command_monitoring_events.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** Extract the actual command from the query, possibly up-converting if it's a legacy format */ function extractCommand(command) {
    ...
    if ((_command_query = command.query) === null || _command_query === void 0 ? void 0 : _command_query.$query) {
        let result;
...
"[project]/node_modules/mongodb/lib/cmap/stream_description.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
    ...
    receiveResponse(response) {
        ...
        if (response.compression) {
            this.compressor = this.compressors.filter((c)=>{
                var _response_compression;
                return (_response_compression = response.compression) === null || _response_compression === void 0 ? void 0 : _response_compression.includes(c);
            })[0];
        }
    }
...
"[project]/node_modules/mongodb/lib/cmap/wire_protocol/on_data.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ function onData(emitter, param) {
    let { timeoutContext, signal } = param;
...
"[project]/node_modules/mongodb/lib/cmap/connection.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/** @internal */ class Connection extends mongo_types_1.TypedEventEmitter {
    ...
    get serviceId() {
        var _this_hello;
        return (_this_hello = this.hello) === null || _this_hello === void 0 ? void 0 : _this_hello.serviceId;
    }
    get loadBalanced() {
    ...
    get shouldEmitAndLogCommand() {
        var _this_authContext, _this_mongoLogger;
        var _ref;
        return (_ref = this.monitorCommands || this.established && !((_this_authContext = this.authContext) === null || _this_authContext === void 0 ? void 0 : _this_authContext.reauthenticating) && ((_this_mongoLogger = this.mongoLogger) === null || _this_mongoLogger === void 0 ? void 0 : _this_mongoLogger.willLog(mongo_logger_1.MongoLoggableComponent.COMMAND, mongo_logger_1.SeverityLevel.DEBUG))) !== null && _ref !== void 0 ? _ref : false;
    }
    markAvailable() {
    ...
    onClose() {
        const message = "connection ".concat(this.id, " to ").concat(this.address, " closed");
        this.cleanup(new error_1.MongoNetworkError(message));
    }
    onTimeout() {
        this.delayedTimeoutId = (0, timers_1.setTimeout)(()=>{
            const message = "connection ".concat(this.id, " to ").concat(this.address, " timed out");
     ...
     */ cleanup(error) {
        var _this_dataEvents;
        if (this.closed) {
            return;
        }
        this.socket.destroy();
        this.error = error;
        (_this_dataEvents = this.dataEvents) === null || _this_dataEvents === void 0 ? void 0 : _this_dataEvents.throw(error).then(undefined, utils_1.squashError);
        this.closed = true;
    ...
    prepareCommand(db, command, options) {
        ...
        if (this.description.type !== common_1.ServerType.Standalone) {
            if (!(0, shared_1.isSharded)(this) && !this.description.loadBalanced && this.supportsOpMsg && options.directConnection === true && (readPreference === null || readPreference === void 0 ? void 0 : readPreference.mode) === 'primary') {
        ...
        (_options_timeoutContext = options.timeoutContext) === null || _options_timeoutContext === void 0 ? void 0 : _options_timeoutContext.addMaxTimeMSToCommand(cmd, options);
    ...
    async *sendWire(message, options, responseType) {
        var _options_timeoutContext;
        this.throwIfAborted();
        var _options_socketTimeoutMS, _ref;
        const timeout = (_ref = (_options_socketTimeoutMS = options.socketTimeoutMS) !== null && _options_socketTimeoutMS !== void 0 ? _options_socketTimeoutMS : options === null || options === void 0 ? void 0 : (_options_timeoutContext = options.timeoutContext) === null || _options_timeoutContext === void 0 ? void 0 : _options_timeoutContext.getSocketTimeoutMS()) !== null && _ref !== void 0 ? _ref : this.socketTimeoutMS;
        this.socket.setTimeout(timeout);
        try {
            var _options_timeoutContext1;
            var _this_description_compressor;
            await this.writeCommand(message, {
                agreedCompressor: (_this_description_compressor = this.description.compressor) !== null && _this_description_compressor !== void 0 ? _this_description_compressor : 'none',
            ...
            this.throwIfAborted();
            if (((_options_timeoutContext1 = options.timeoutContext) === null || _options_timeoutContext1 === void 0 ? void 0 : _options_timeoutContext1.csotEnabled()) && options.timeoutContext.minRoundTripTime != null && options.timeoutContext.remainingTimeMS < options.timeoutContext.minRoundTripTime) {
    ...
    async *sendCommand(ns, command, options, responseType) {
        ...
        try {
            ...
            for await (document of this.sendWire(message, options, responseType)){
                ...
                if (document.ok === 0) {
                    var _options_timeoutContext;
                    if (((_options_timeoutContext = options.timeoutContext) === null || _options_timeoutContext === void 0 ? void 0 : _options_timeoutContext.csotEnabled()) && document.isMaxTimeExpiredError) {
                ...
                if (responseType == null) {
                    yield object !== null && object !== void 0 ? object : object = document.toObject(bsonOptions);
                } else {
                    yield document;
                }
                this.throwIfAborted();
    ...
    async command(ns, command) {
        let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, responseType = arguments.length > 3 ? arguments[3] : void 0;
        var _options_signal;
        this.throwIfAborted();
        (_options_signal = options.signal) === null || _options_signal === void 0 ? void 0 : _options_signal.throwIfAborted();
        for await (const document of this.sendCommand(ns, command, options, responseType)){
            var _options_timeoutContext;
            if ((_options_timeoutContext = options.timeoutContext) === null || _options_timeoutContext === void 0 ? void 0 : _options_timeoutContext.csotEnabled()) {
                if (responses_1.MongoDBResponse.is(document)) {
                    ...
                    var _document_writeConcernError;
                    if (Array.isArray(document === null || document === void 0 ? void 0 : document.writeErrors) && document.writeErrors.some((error)=>(error === null || error === void 0 ? void 0 : error.code) === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired) || (document === null || document === void 0 ? void 0 : (_document_writeConcernError = document.writeConcernError) === null || _document_writeConcernError === void 0 ? void 0 : _document_writeConcernError.code) === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired) {
                        throw new error_1.MongoOperationTimeoutError('Server reported a timeout error', {
     ...
     */ async writeCommand(command, options) {
        ...
        var _options_agreedCompressor, _options_zlibCompressionLevel;
        const finalCommand = options.agreedCompressor === 'none' || !commands_1.OpCompressedRequest.canCompress(command) ? command : new commands_1.OpCompressedRequest(command, {
            agreedCompressor: (_options_agreedCompressor = options.agreedCompressor) !== null && _options_agreedCompressor !== void 0 ? _options_agreedCompressor : 'none',
            zlibCompressionLevel: (_options_zlibCompressionLevel = options.zlibCompressionLevel) !== null && _options_zlibCompressionLevel !== void 0 ? _options_zlibCompressionLevel : 0
        });
        ...
        const timeout = options === null || options === void 0 ? void 0 : (_options_timeoutContext1 = options.timeoutContext) === null || _options_timeoutContext1 === void 0 ? void 0 : _options_timeoutContext1.timeoutForSocketWrite;
        ...
        try {
            ...
            if (timeout_1.TimeoutError.is(writeError)) {
                ...
                throw timeoutError;
            } else if (writeError === ((_options_signal = options.signal) === null || _options_signal === void 0 ? void 0 : _options_signal.reason)) {
     ...
     */ async *readMany(options) {
        try {
            ...
            if (timeout_1.TimeoutError.is(readError)) {
                const timeoutError = new error_1.MongoOperationTimeoutError("Timed out during socket read (".concat(readError.duration, "ms)"));
                this.dataEvents = null;
                this.onError(timeoutError);
                throw timeoutError;
            } else if (readError === ((_options_signal = options.signal) === null || _options_signal === void 0 ? void 0 : _options_signal.reason)) {
    ...
    constructor(stream, options){
        ...
        var _options_socketTimeoutMS;
        this.socketTimeoutMS = (_options_socketTimeoutMS = options.socketTimeoutMS) !== null && _options_socketTimeoutMS !== void 0 ? _options_socketTimeoutMS : 0;
    ...
    _transform(chunk, encoding, callback) {
        ...
        while(this.bufferPool.length){
            ...
            if (sizeOfMessage < 0) {
                ...
                return callback(new error_1.MongoParseError("Message size cannot be negative: ".concat(sizeOfMessage)));
            }
...
/** @internal */ class CryptoConnection extends Connection {
    async command(ns, cmd, options, responseType) {
        ...
        var _responseType_make;
        const decryptedResponse = (_responseType_make = responseType === null || responseType === void 0 ? void 0 : responseType.make(result)) !== null && _responseType_make !== void 0 ? _responseType_make : (0, bson_1.deserialize)(result, options);
...
"[project]/node_modules/mongodb/lib/cmap/connect.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function makeConnection(options, socket) {
    var _options_connectionType;
    let ConnectionType = (_options_connectionType = options.connectionType) !== null && _options_connectionType !== void 0 ? _options_connectionType : connection_1.Connection;
...
function checkSupportedServer(hello, options) {
    ...
    if (serverVersionHighEnough) {
        ...
        const message = "Server at ".concat(options.hostAddress, " reports minimum wire version ").concat(JSON.stringify(hello.minWireVersion), ", but this version of the Node.js Driver requires at most ").concat(constants_2.MAX_SUPPORTED_WIRE_VERSION, " (MongoDB ").concat(constants_2.MAX_SUPPORTED_SERVER_VERSION, ")");
        return new error_1.MongoCompatibilityError(message);
    }
    var _JSON_stringify;
    const message = "Server at ".concat(options.hostAddress, " reports maximum wire version ").concat((_JSON_stringify = JSON.stringify(hello.maxWireVersion)) !== null && _JSON_stringify !== void 0 ? _JSON_stringify : 0, ", but this version of the Node.js Driver requires at least ").concat(constants_2.MIN_SUPPORTED_WIRE_VERSION, " (MongoDB ").concat(constants_2.MIN_SUPPORTED_SERVER_VERSION, ")");
    return new error_1.MongoCompatibilityError(message);
}
...
function parseConnectOptions(options) {
    ...
    var _keepAliveInitialDelay;
    (_keepAliveInitialDelay = (_result = result).keepAliveInitialDelay) !== null && _keepAliveInitialDelay !== void 0 ? _keepAliveInitialDelay : _result.keepAliveInitialDelay = 120000;
    result.keepAlive = true;
    var _options_noDelay;
    result.noDelay = (_options_noDelay = options.noDelay) !== null && _options_noDelay !== void 0 ? _options_noDelay : true;
...
async function makeSocket(options) {
    var _options_tls;
    const useTLS = (_options_tls = options.tls) !== null && _options_tls !== void 0 ? _options_tls : false;
    var _options_connectTimeoutMS;
    const connectTimeoutMS = (_options_connectTimeoutMS = options.connectTimeoutMS) !== null && _options_connectTimeoutMS !== void 0 ? _options_connectTimeoutMS : 30000;
    ...
    if (existingSocket) {
        ...
        socket.once(connectEvent, ()=>resolve(socket)).once('error', (cause)=>reject(new error_1.MongoNetworkError(error_1.MongoError.buildErrorMessage(cause), {
            ...
            reject(new error_1.MongoNetworkTimeoutError("Socket '".concat(connectEvent, "' timed out after ").concat(performance.now() - start | 0, "ms (connectTimeoutMS: ").concat(connectTimeoutMS, ")")));
        }).once('close', ()=>reject(new error_1.MongoNetworkError("Socket closed after ".concat(performance.now() - start | 0, " during connection establishment"))));
        if (options.cancellationToken != null) {
            cancellationHandler = ()=>reject(new error_1.MongoNetworkError("Socket connection establishment was cancelled after ".concat(performance.now() - start | 0)));
    ...
    try {
        ...
        if (cancellationHandler != null) {
            var _options_cancellationToken;
            (_options_cancellationToken = options.cancellationToken) === null || _options_cancellationToken === void 0 ? void 0 : _options_cancellationToken.removeListener('cancel', cancellationHandler);
        }
    }
}
let socks = null;
...
async function makeSocks5Connection(options) {
    var _options_proxyHost, _options_proxyPort;
    const hostAddress = utils_1.HostAddress.fromHostPort((_options_proxyHost = options.proxyHost) !== null && _options_proxyHost !== void 0 ? _options_proxyHost : '', (_options_proxyPort = options.proxyPort) !== null && _options_proxyPort !== void 0 ? _options_proxyPort : 1080);
...
"[project]/node_modules/mongodb/lib/cmap/connection_pool_events.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/errors.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class PoolClearedError extends error_1.MongoNetworkError {
     ...
     **/ constructor(pool, message){
        var _pool_serverError;
        const errorMessage = message ? message : "Connection pool for ".concat(pool.address, ' was cleared because another operation failed with: "').concat((_pool_serverError = pool.serverError) === null || _pool_serverError === void 0 ? void 0 : _pool_serverError.message, '"');
 ...
 */ class PoolClearedOnNetworkError extends PoolClearedError {
     ...
     * @public
     **/ constructor(pool){
        super(pool, "Connection to ".concat(pool.address, " interrupted due to server monitor timeout"));
    }
}
...
"[project]/node_modules/mongodb/lib/cmap/connection_pool.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class ConnectionPool extends mongo_types_1.TypedEventEmitter {
     ...
     */ clear() {
        ...
        var _options_interruptInUseConnections;
        // handle non load-balanced case
        const interruptInUseConnections = (_options_interruptInUseConnections = options.interruptInUseConnections) !== null && _options_interruptInUseConnections !== void 0 ? _options_interruptInUseConnections : false;
     ...
     */ async reauthenticate(connection) {
        ...
        if (!provider) {
            throw new error_1.MongoMissingCredentialsError("Reauthenticate failed due to no auth provider for ".concat(credentials.mechanism));
        }
    ...
    constructor(server, options){
        ...
        super();
        this.on('error', utils_1.noop);
        var _options_maxPoolSize, _options_minPoolSize, _options_maxConnecting, _options_maxIdleTimeMS, _options_waitQueueTimeoutMS, _options_minPoolSizeCheckFrequencyMS;
        this.options = Object.freeze({
            connectionType: connection_1.Connection,
            ...options,
            maxPoolSize: (_options_maxPoolSize = options.maxPoolSize) !== null && _options_maxPoolSize !== void 0 ? _options_maxPoolSize : 100,
            minPoolSize: (_options_minPoolSize = options.minPoolSize) !== null && _options_minPoolSize !== void 0 ? _options_minPoolSize : 0,
            maxConnecting: (_options_maxConnecting = options.maxConnecting) !== null && _options_maxConnecting !== void 0 ? _options_maxConnecting : 2,
            maxIdleTimeMS: (_options_maxIdleTimeMS = options.maxIdleTimeMS) !== null && _options_maxIdleTimeMS !== void 0 ? _options_maxIdleTimeMS : 0,
            waitQueueTimeoutMS: (_options_waitQueueTimeoutMS = options.waitQueueTimeoutMS) !== null && _options_waitQueueTimeoutMS !== void 0 ? _options_waitQueueTimeoutMS : 0,
            minPoolSizeCheckFrequencyMS: (_options_minPoolSizeCheckFrequencyMS = options.minPoolSizeCheckFrequencyMS) !== null && _options_minPoolSizeCheckFrequencyMS !== void 0 ? _options_minPoolSizeCheckFrequencyMS : 100,
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_aws.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class MongoDBAWS extends auth_provider_1.AuthProvider {
    async auth(authContext) {
        ...
        const saslStartResponse = await connection.command((0, utils_1.ns)("".concat(db, ".$cmd")), saslStart, undefined);
        ...
        await connection.command((0, utils_1.ns)("".concat(db, ".$cmd")), saslContinue, undefined);
    }
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/command_builders.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/callback_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/automated_callback_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/azure_machine_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ async function getAzureTokenData(tokenAudience, username) {
    ...
    if (response.status !== 200) {
        throw new error_1.MongoAzureError("Status code ".concat(response.status, " returned from the Azure endpoint. Response body: ").concat(response.body));
    }
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/gcp_machine_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ async function getGcpTokenData(tokenAudience) {
    ...
    if (response.status !== 200) {
        throw new error_1.MongoGCPError("Status code ".concat(response.status, " returned from the GCP endpoint. Response body: ").concat(response.body));
    }
    return {
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/k8s_machine_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/token_cache.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/token_machine_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class MongoDBOIDC extends auth_provider_1.AuthProvider {
     ...
     */ async auth(authContext) {
        var _response_speculativeAuthenticate;
        const { connection, reauthenticating, response } = authContext;
        if ((response === null || response === void 0 ? void 0 : (_response_speculativeAuthenticate = response.speculativeAuthenticate) === null || _response_speculativeAuthenticate === void 0 ? void 0 : _response_speculativeAuthenticate.done) && !reauthenticating) {
            return;
        }
...
"[project]/node_modules/mongodb/lib/cmap/auth/mongodb_oidc/human_callback_workflow.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mongodb/lib/cmap/auth/plain.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class Plain extends auth_provider_1.AuthProvider {
    async auth(authContext) {
        ...
        const { username, password } = credentials;
        const payload = new bson_1.Binary(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from("\0".concat(username, "\0").concat(password)));
        const command = {
            saslStart: 1,
            mechanism: 'PLAIN',
            payload: payload,
...
"[project]/node_modules/mongodb/lib/cmap/auth/scram.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
async function executeScram(cryptoMethod, authContext) {
    ...
    const response = await connection.command((0, utils_1.ns)("".concat(db, ".$cmd")), saslStartCmd, undefined);
...
async function continueScramConversation(cryptoMethod, response, authContext) {
    ...
    const r = await connection.command((0, utils_1.ns)("".concat(db, ".$cmd")), saslContinueCmd, undefined);
    ...
    await connection.command((0, utils_1.ns)("".concat(db, ".$cmd")), retrySaslContinueCmd, undefined);
}
function parsePayload(payload) {
    ...
    for(let i = 0; i < parts.length; i++){
        var _parts_i_match;
        const valueParts = ((_parts_i_match = parts[i].match(/^([^=]*)=(.*)$/)) !== null && _parts_i_match !== void 0 ? _parts_i_match : []).slice(1);
...
"[project]/node_modules/mongodb/lib/cmap/auth/x509.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
//# sourceMappingURL=node_modules_mongodb_lib_cmap_70bddff7._.js.map